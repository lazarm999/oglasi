...
var Item = /** @class */ (function () {
    ...
    Object.defineProperty(Item.prototype, "offset", {
        get: function () {
            ...
            var _b = this.dimensions, _c = _b.fixTop, fixTop = _c === void 0 ? 0 : _c, _d = _b.fixLeft, fixLeft = _d === void 0 ? 0 : _d;
            ...
            if (this.scatter > 0 || ((_a = this.rotatingScatter) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                var _e = this.calcScatter(offset), x = _e.x, y = _e.y;
                offset.left += x;
                offset.top += y;
                offset.right = offset.left + this.width;
                offset.bottom = offset.top + this.height;
            ...
            this.style.cubedWidth =
                ...
                this.style.orgWidth =
                    ...
                    this.style.width =
                        // prettier-ignore
                        Math.max(1, w);
            var _a = this.dimensions.fixLeft, fixLeft = _a === void 0 ? 0 : _a;
            ...
            this.style.cubedHeight =
                ...
                this.style.orgHeight =
                    ...
                    this.style.height =
                        // prettier-ignore
                        Math.max(1, h);
            var _a = this.dimensions.fixTop, fixTop = _a === void 0 ? 0 : _a;
    ...
    Object.defineProperty(Item.prototype, "dimensions", {
        get: function () {
            ...
            var isLandscape = this.ratio >= this.cubeRatio; //relative to container size
            if (isGridFit) {
    ...
    Object.defineProperty(Item.prototype, "cubeRatio", {
        get: function () {
            var _this = this;
            var ratio;

...
var Layouter = /** @class */ (function () {
    ...
    Layouter.prototype.updateParams = function (layoutParams) {
        ...
        this.styleParams = utils_1.utils.convertStyleParams(layoutParams.styleParams);
    ...
    Layouter.prototype.prepareLayoutParams = function () {
        ...
        if (this.useExistingLayout && this.pointer > 0) {
            ...
            this.targetItemSize = this.styleParams.isVertical
                ...
                : this.targetItemSize;
            var _a = this.styleParams, columnWidths = _a.columnWidths, cubeRatio_1 = _a.cubeRatio, externalInfoWidth_1 = _a.externalInfoWidth, imageMargin_1 = _a.imageMargin;
            ...
            this.columns = Array(this.numOfCols)
                ...
                fixedCubeHeight_1 =
                    fixedCubeHeight_1 ||
                        (_this.targetItemSize - infoWidth - imageMargin_1) / cubeRatio_1 +
    ...
    Layouter.prototype.createLayout = function (layoutParams) {
        ...
        if (this.styleParams.forceFullHeight) {
            ...
            this.items.map(function (item) {
                ...
                item.cubeRatio = item.ratio = item.width / (item.height * stretchRatio_1);

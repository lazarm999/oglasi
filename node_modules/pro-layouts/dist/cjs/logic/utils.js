...
var Utils = /** @class */ (function () {
    ...
    Utils.prototype.insertIfDefined = function (obj, field, value) {
        if (typeof value !== 'undefined') {
            obj[field] = value;
        }
    };
    Utils.prototype.convertStyleParams = function (styleParams) {
        //default styleParams
        ...
        this.insertIfDefined(convertedStyleParams, 'rotatingCropRatios', Array.isArray(convertedStyleParams.rotatingCropRatios)
        ...
        this.insertIfDefined(convertedStyleParams, 'groupTypes', Array.isArray(convertedStyleParams.allowedGroupTypes)
            ? convertedStyleParams.allowedGroupTypes.join(',')
            : undefined);
        this.insertIfDefined(convertedStyleParams, 'rotatingGroupTypes', Array.isArray(convertedStyleParams.rotatingGroupTypes)
        ...
        this.insertIfDefined(convertedStyleParams, 'columnWidths', Array.isArray(convertedStyleParams.columnWidths)

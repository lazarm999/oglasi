...
var defaultStyles_1 = tslib_1.__importDefault(require("../../common/defaultStyles"));
var presets_1 = require("../presets/presets");
var dimensionsHelper_1 = tslib_1.__importDefault(require("../helpers/dimensionsHelper"));
var itemsHelper_1 = require("../helpers/itemsHelper");
var layoutHelper_js_1 = tslib_1.__importDefault(require("../helpers/layoutHelper.js"));
var Blueprints = /** @class */ (function () {
    ...
    Blueprints.prototype.formatItemsIfNeeded = function (items, lastItems) {
        ...
        if (itemsWereAdded(items, oldItemsParams)) {
            formattedItems = oldItemsParams.concat(items.slice(oldItemsParams.length).map(function (item) {
                return itemsHelper_1.ItemsHelper.convertDtoToLayoutItem(item);
            }));
            ...
            formattedItems = items.map(function (item) {
                return Object.assign(itemsHelper_1.ItemsHelper.convertDtoToLayoutItem(item));
            });
    ...
    Blueprints.prototype.formatStylesIfNeeded = function (styles, lastStyles, isUsingCustomInfoElements) {
        ...
        if (stylesHaveChanged(styles, oldStylesParams)) {
            styles = tslib_1.__assign(tslib_1.__assign({}, defaultStyles_1.default), styles);
            formattedStyles = layoutHelper_js_1.default(presets_1.addPresetStyles(styles), isUsingCustomInfoElements); // TODO make sure the processLayouts is up to date. delete addLayoutStyles from layoutsHelper when done with it...
            changed = true;
        }
    ...
    Blueprints.prototype.formatContainerIfNeeded = function (dimensions, lastDimensions, lastStyles, formattedStyles, stylesChanged) {
        ...
        if (stylesChanged || // If styles changed they could affect the container and a new container must be created (slideshow,thumbs,shadow,borders...etc)
            ...
            dimensionsHelper_1.default.updateParams({
                styles: formattedStyles,
                container: dimensions,
            });
            changed = true;
            formattedContainer = Object.assign({}, dimensions, dimensionsHelper_1.default.getGalleryDimensions());
        }

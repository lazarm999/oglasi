...
var Utils = /** @class */ (function () {
    ...
    Utils.prototype.isMobileByProps = function () {
        ...
        var _isMobileByProps = function () {
            ...
            var formFactorMobile = viewModeWrapper_1.isFormFactorMobile();
            if (isMobileViewer) {
                return true;
            }
            else if (deviceType) {
    ...
    Utils.prototype.logPlaygroundLink = function (styles) {
        try {
            if (this.isVerbose()) {
                var stylesStr = Object.entries(styles)
                    .filter(function (_a) {
                    ...
                    .join('&');
                console.log('Gallery Playground link:', "https://pro-gallery.surge.sh?" + stylesStr);
            }
        }
        catch (e) {
            console.error(e);
    ...
    Utils.prototype.isSingleItemHorizontalDisplay = function (styles) {
        return styles.scrollDirection === constants_1.default.scrollDirection.HORIZONTAL &&
            styles.groupSize === 1 &&
            styles.cubeImages &&
    ...
    Utils.prototype.getAriaAttributes = function (_a) {
        ...
        return _b = {
            ...
            _b['aria-roledescription'] = proGalleryRole === 'application' ? 'gallery application' : 'region',
            _b;
    };
